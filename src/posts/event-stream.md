...
The initial payload was found added to a dependency of the npm package event-stream November 2018. The attacker started by social engineering access to the package, gaining trust with the community, and then adding a dependency that was later updated to include the malicious payload A below.

This was a widely distributed package but the damage was isolated to the bitcoin wallet Copay by targeting its build system.

- - -

## References

- [Exploiting Developer Infrastructure is Insanely Easy](https://medium.com/s/story/exploiting-developer-infrastructure-is-insanely-easy-9849937e81d4)
...
The first two elements in the array unhex to binary data which needs to be decrypted with the key "A Secure Bitcoin Wallet".
